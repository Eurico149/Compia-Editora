...
async def create_produto(produto_dto: ProdutoDTO):
    return await produto_controller.create(produto_dto)

@editor_router.put("/product")
async def change_produto(produto_dto: ProdutoDTO):
    return await produto_controller.change(produto_dto)

@editor_router.delete("/product/{uid}")
async def delete_produto(uid: str):
    return await produto_controller.delete(uid)
